...
class AppThemeData extends ChangeNotifier {
  ...
  Color colorCompanion = const Color.fromARGB(255, 255, 255, 255);
  Color colorCompanion2 = const Color.fromARGB(255, 143, 159, 238);
  Color colorCompanion3 = const Color(0xFF455BC6);
  Color colorCompanion4 = const Color.fromARGB(255, 75, 31, 145);
  Color colorCompanion1 = const Color.fromARGB(255, 60, 83, 216);
  ...
  Color colorDarkModeLight =
      const Color.fromARGB(255, 0, 0, 0); // for dialog background in dark mode
